...
const ProjectCard = ({
  ...
  useEffect(() => {
    const handleScroll = () => {
      const cardPosition = document
        .getElementById(`project-${item.id}`)
  ...
  return (
    ...
    >
      ...
      >
        <img
          src={`https://rotyixpntplxytekbeuz.supabase.co/storage/v1/object/public/project_photos/${item.id}/${item.id}/Project_pic.png`}
          style={{ display: "none" }}
          alt="hlopushka"
      ...
      <div className={styles.project_text}>
        ...
        {table == "Projects" ? (
          ...
          <h2 className={styles.medium_title3}>Роль в проекте - {item.role}</h2>
        )}
