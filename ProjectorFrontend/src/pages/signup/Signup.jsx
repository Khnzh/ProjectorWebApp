  ...
  return (
    <div className={styles.signup__cnt}>
      ...
      <input
        ...
        type="email"
        className={"login__input " + StyleSheet.signup}
        id="email"
      />
      ...
      <input
        onChange={(e) => updName(e.target.value)}
        placeholder="Имя"
        type="text"
        className={"login__input " + StyleSheet.signup}
        id="name"
      ...
      <input
        onChange={(e) => updLastName(e.target.value)}
        placeholder="Фамилия"
        type="text"
        className={"login__input " + StyleSheet.signup}
        id="second_name"
      ...
      <div className="signup__radio__cnt no-underline">
        <input
          onClick={(e) => updSex(e.target.value)}
          type="radio"
          id="sex_m"
          name="sex"
          value={false}
        />
        <label htmlFor="sex_m">
          <svg className="radio sign__svg" viewBox="0 0 40 38">
            <path
              className="box"
          ...
          <span className="radio__label signup__label">М</span>
        </label>
        <input
          onClick={(e) => updSex(e.target.value)}
          type="radio"
        ...
        <label htmlFor="sex_f">
          ...
          <span className="radio__label signup__label">Ж</span>
        </label>
      </div>
      {errors.sex && <p className="validation-message">{errors.sex}</p>}
      <input
        onChange={(e) => updDob(e.target.value)}
      ...
      <ul>
        <li>
          <input
            onClick={updAgreement}
            type="checkbox"
            id="agreement"
            name="agreement"
            value="agreed_to_data"
            required
          />
          <label htmlFor="agreement" className="radio__label">
            <svg className="sign__svg" viewBox="0 0 40 38">
              <path
                className="box"
                d="M31.7,2.1C23.3,2.3,14.9,3.2,6.4,3.6C3.6,3.8,1.3,6.3,1.5,9.1c2.1,32.2-4.1,26.5,20.9,26.5
                    c4.1,0,16.2,1.1,15.6-2.4c-0.5-3.1-0.7-10.7-1.1-13.8c-0.2-2.3-0.2-8.5-0.8-13.6C36,3.6,34,2,31.7,2.1z"
            ...
            <span className={styles.sign__label}>
              Соглашаюсь с Обработкой персональных данных
            </span>
          </label>
          {errors.agreement && (
            <p className="validation-message">{errors.agreement}</p>
          )}
        </li>
        <li>
          <input
            ...
            id="policy"
            name="policy"
            value="agreed_to_policy"
            required
          />
          <label htmlFor="policy" className="radio__label">
            <svg className="sign__svg" viewBox="0 0 40 38">
              <path
                className="box"
                d="M31.7,2.1C23.3,2.3,14.9,3.2,6.4,3.6C3.6,3.8,1.3,6.3,1.5,9.1c2.1,32.2-4.1,26.5,20.9,26.5
          ...
          {errors.policy && (
            <p className="validation-message">{errors.policy}</p>
          )}
        </li>
        <li>
          <input
            onClick={updSubscription}
            type="checkbox"
            id="subscribe"
            name="sub_to_news"
            value="subscribed"
          />
          <label htmlFor="subscribe" className="radio__label">
            <svg className="sign__svg" viewBox="0 0 40 38">
              <path
                className="box"
                d="M31.7,2.1C23.3,2.3,14.9,3.2,6.4,3.6C3.6,3.8,1.3,6.3,1.5,9.1c2.1,32.2-4.1,26.5,20.9,26.5
            ...
            <span className={styles.sign__label}>Подписаться на рассылку</span>
          </label>
        </li>
      </ul>
